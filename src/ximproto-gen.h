...
#define frame_read_func(FRAME) _Generic((FRAME), \
    ximattr_fr : ximattr_fr_read,\
    xicattr_fr : xicattr_fr_read,\
    ximattribute_fr : ximattribute_fr_read,\
    xicattribute_fr : xicattribute_fr_read,\
    ximtriggerkey_fr : ximtriggerkey_fr_read,\
    encodinginfo_fr : encodinginfo_fr_read,\
    str_fr : str_fr_read,\
    xpcs_fr : xpcs_fr_read,\
    ext_fr : ext_fr_read,\
    inputstyle_fr : inputstyle_fr_read,\
    attr_head_fr : attr_head_fr_read,\
    short_fr : short_fr_read,\
    long_fr : long_fr_read,\
    xrectangle_fr : xrectangle_fr_read,\
    xpoint_fr : xpoint_fr_read,\
    fontset_fr : fontset_fr_read,\
    input_styles_fr : input_styles_fr_read,\
    packet_header_fr : packet_header_fr_read,\
    error_fr : error_fr_read,\
    connect_fr : connect_fr_read,\
    connect_reply_fr : connect_reply_fr_read,\
    auth_required_fr : auth_required_fr_read,\
    auth_reply_fr : auth_reply_fr_read,\
    auth_next_fr : auth_next_fr_read,\
    auth_setup_fr : auth_setup_fr_read,\
    auth_ng_fr : auth_ng_fr_read,\
    disconnect_fr : disconnect_fr_read,\
    disconnect_reply_fr : disconnect_reply_fr_read,\
    open_fr : open_fr_read,\
    open_reply_fr : open_reply_fr_read,\
    close_fr : close_fr_read,\
    close_reply_fr : close_reply_fr_read,\
    register_triggerkeys_fr : register_triggerkeys_fr_read,\
    trigger_notify_fr : trigger_notify_fr_read,\
    trigger_notify_reply_fr : trigger_notify_reply_fr_read,\
    set_event_mask_fr : set_event_mask_fr_read,\
    encoding_negotiation_fr : encoding_negotiation_fr_read,\
    encoding_negotiation_reply_fr : encoding_negotiation_reply_fr_read,\
    query_extension_fr : query_extension_fr_read,\
    query_extension_reply_fr : query_extension_reply_fr_read,\
    get_im_values_fr : get_im_values_fr_read,\
    get_im_values_reply_fr : get_im_values_reply_fr_read,\
    create_ic_fr : create_ic_fr_read,\
    create_ic_reply_fr : create_ic_reply_fr_read,\
    destroy_ic_fr : destroy_ic_fr_read,\
    destroy_ic_reply_fr : destroy_ic_reply_fr_read,\
    set_ic_values_fr : set_ic_values_fr_read,\
    set_ic_values_reply_fr : set_ic_values_reply_fr_read,\
    get_ic_values_fr : get_ic_values_fr_read,\
    get_ic_values_reply_fr : get_ic_values_reply_fr_read,\
    set_ic_focus_fr : set_ic_focus_fr_read,\
    unset_ic_focus_fr : unset_ic_focus_fr_read,\
    forward_event_fr : forward_event_fr_read,\
    sync_fr : sync_fr_read,\
    sync_reply_fr : sync_reply_fr_read,\
    commit_fr : commit_fr_read,\
    commit_chars_fr : commit_chars_fr_read,\
    commit_both_fr : commit_both_fr_read,\
    reset_ic_fr : reset_ic_fr_read,\
    reset_ic_reply_fr : reset_ic_reply_fr_read,\
    geometry_fr : geometry_fr_read,\
    str_conversion_fr : str_conversion_fr_read,\
    str_conversion_reply_fr : str_conversion_reply_fr_read,\
    preedit_start_fr : preedit_start_fr_read,\
    preedit_start_reply_fr : preedit_start_reply_fr_read,\
    preedit_draw_fr : preedit_draw_fr_read,\
    preedit_caret_fr : preedit_caret_fr_read,\
    preedit_caret_reply_fr : preedit_caret_reply_fr_read,\
    preedit_done_fr : preedit_done_fr_read,\
    status_start_fr : status_start_fr_read,\
    status_draw_text_fr : status_draw_text_fr_read,\
    status_draw_bitmap_fr : status_draw_bitmap_fr_read,\
    status_done_fr : status_done_fr_read,\
    ext_set_event_mask_fr : ext_set_event_mask_fr_read,\
    ext_forward_keyevent_fr : ext_forward_keyevent_fr_read,\
    ext_move_fr : ext_move_fr_read)

#define frame_write_func(FRAME) _Generic((FRAME), \
    ximattr_fr : ximattr_fr_write,\
    xicattr_fr : xicattr_fr_write,\
    ximattribute_fr : ximattribute_fr_write,\
    xicattribute_fr : xicattribute_fr_write,\
    ximtriggerkey_fr : ximtriggerkey_fr_write,\
    encodinginfo_fr : encodinginfo_fr_write,\
    str_fr : str_fr_write,\
    xpcs_fr : xpcs_fr_write,\
    ext_fr : ext_fr_write,\
    inputstyle_fr : inputstyle_fr_write,\
    attr_head_fr : attr_head_fr_write,\
    short_fr : short_fr_write,\
    long_fr : long_fr_write,\
    xrectangle_fr : xrectangle_fr_write,\
    xpoint_fr : xpoint_fr_write,\
    fontset_fr : fontset_fr_write,\
    input_styles_fr : input_styles_fr_write,\
    packet_header_fr : packet_header_fr_write,\
    error_fr : error_fr_write,\
    connect_fr : connect_fr_write,\
    connect_reply_fr : connect_reply_fr_write,\
    auth_required_fr : auth_required_fr_write,\
    auth_reply_fr : auth_reply_fr_write,\
    auth_next_fr : auth_next_fr_write,\
    auth_setup_fr : auth_setup_fr_write,\
    auth_ng_fr : auth_ng_fr_write,\
    disconnect_fr : disconnect_fr_write,\
    disconnect_reply_fr : disconnect_reply_fr_write,\
    open_fr : open_fr_write,\
    open_reply_fr : open_reply_fr_write,\
    close_fr : close_fr_write,\
    close_reply_fr : close_reply_fr_write,\
    register_triggerkeys_fr : register_triggerkeys_fr_write,\
    trigger_notify_fr : trigger_notify_fr_write,\
    trigger_notify_reply_fr : trigger_notify_reply_fr_write,\
    set_event_mask_fr : set_event_mask_fr_write,\
    encoding_negotiation_fr : encoding_negotiation_fr_write,\
    encoding_negotiation_reply_fr : encoding_negotiation_reply_fr_write,\
    query_extension_fr : query_extension_fr_write,\
    query_extension_reply_fr : query_extension_reply_fr_write,\
    get_im_values_fr : get_im_values_fr_write,\
    get_im_values_reply_fr : get_im_values_reply_fr_write,\
    create_ic_fr : create_ic_fr_write,\
    create_ic_reply_fr : create_ic_reply_fr_write,\
    destroy_ic_fr : destroy_ic_fr_write,\
    destroy_ic_reply_fr : destroy_ic_reply_fr_write,\
    set_ic_values_fr : set_ic_values_fr_write,\
    set_ic_values_reply_fr : set_ic_values_reply_fr_write,\
    get_ic_values_fr : get_ic_values_fr_write,\
    get_ic_values_reply_fr : get_ic_values_reply_fr_write,\
    set_ic_focus_fr : set_ic_focus_fr_write,\
    unset_ic_focus_fr : unset_ic_focus_fr_write,\
    forward_event_fr : forward_event_fr_write,\
    sync_fr : sync_fr_write,\
    sync_reply_fr : sync_reply_fr_write,\
    commit_fr : commit_fr_write,\
    commit_chars_fr : commit_chars_fr_write,\
    commit_both_fr : commit_both_fr_write,\
    reset_ic_fr : reset_ic_fr_write,\
    reset_ic_reply_fr : reset_ic_reply_fr_write,\
    geometry_fr : geometry_fr_write,\
    str_conversion_fr : str_conversion_fr_write,\
    str_conversion_reply_fr : str_conversion_reply_fr_write,\
    preedit_start_fr : preedit_start_fr_write,\
    preedit_start_reply_fr : preedit_start_reply_fr_write,\
    preedit_draw_fr : preedit_draw_fr_write,\
    preedit_caret_fr : preedit_caret_fr_write,\
    preedit_caret_reply_fr : preedit_caret_reply_fr_write,\
    preedit_done_fr : preedit_done_fr_write,\
    status_start_fr : status_start_fr_write,\
    status_draw_text_fr : status_draw_text_fr_write,\
    status_draw_bitmap_fr : status_draw_bitmap_fr_write,\
    status_done_fr : status_done_fr_write,\
    ext_set_event_mask_fr : ext_set_event_mask_fr_write,\
    ext_forward_keyevent_fr : ext_forward_keyevent_fr_write,\
    ext_move_fr : ext_move_fr_write)

#define frame_size_func(FRAME) _Generic((FRAME), \
    ximattr_fr : ximattr_fr_size,\
    xicattr_fr : xicattr_fr_size,\
    ximattribute_fr : ximattribute_fr_size,\
    xicattribute_fr : xicattribute_fr_size,\
    ximtriggerkey_fr : ximtriggerkey_fr_size,\
    encodinginfo_fr : encodinginfo_fr_size,\
    str_fr : str_fr_size,\
    xpcs_fr : xpcs_fr_size,\
    ext_fr : ext_fr_size,\
    inputstyle_fr : inputstyle_fr_size,\
    attr_head_fr : attr_head_fr_size,\
    short_fr : short_fr_size,\
    long_fr : long_fr_size,\
    xrectangle_fr : xrectangle_fr_size,\
    xpoint_fr : xpoint_fr_size,\
    fontset_fr : fontset_fr_size,\
    input_styles_fr : input_styles_fr_size,\
    packet_header_fr : packet_header_fr_size,\
    error_fr : error_fr_size,\
    connect_fr : connect_fr_size,\
    connect_reply_fr : connect_reply_fr_size,\
    auth_required_fr : auth_required_fr_size,\
    auth_reply_fr : auth_reply_fr_size,\
    auth_next_fr : auth_next_fr_size,\
    auth_setup_fr : auth_setup_fr_size,\
    auth_ng_fr : auth_ng_fr_size,\
    disconnect_fr : disconnect_fr_size,\
    disconnect_reply_fr : disconnect_reply_fr_size,\
    open_fr : open_fr_size,\
    open_reply_fr : open_reply_fr_size,\
    close_fr : close_fr_size,\
    close_reply_fr : close_reply_fr_size,\
    register_triggerkeys_fr : register_triggerkeys_fr_size,\
    trigger_notify_fr : trigger_notify_fr_size,\
    trigger_notify_reply_fr : trigger_notify_reply_fr_size,\
    set_event_mask_fr : set_event_mask_fr_size,\
    encoding_negotiation_fr : encoding_negotiation_fr_size,\
    encoding_negotiation_reply_fr : encoding_negotiation_reply_fr_size,\
    query_extension_fr : query_extension_fr_size,\
    query_extension_reply_fr : query_extension_reply_fr_size,\
    get_im_values_fr : get_im_values_fr_size,\
    get_im_values_reply_fr : get_im_values_reply_fr_size,\
    create_ic_fr : create_ic_fr_size,\
    create_ic_reply_fr : create_ic_reply_fr_size,\
    destroy_ic_fr : destroy_ic_fr_size,\
    destroy_ic_reply_fr : destroy_ic_reply_fr_size,\
    set_ic_values_fr : set_ic_values_fr_size,\
    set_ic_values_reply_fr : set_ic_values_reply_fr_size,\
    get_ic_values_fr : get_ic_values_fr_size,\
    get_ic_values_reply_fr : get_ic_values_reply_fr_size,\
    set_ic_focus_fr : set_ic_focus_fr_size,\
    unset_ic_focus_fr : unset_ic_focus_fr_size,\
    forward_event_fr : forward_event_fr_size,\
    sync_fr : sync_fr_size,\
    sync_reply_fr : sync_reply_fr_size,\
    commit_fr : commit_fr_size,\
    commit_chars_fr : commit_chars_fr_size,\
    commit_both_fr : commit_both_fr_size,\
    reset_ic_fr : reset_ic_fr_size,\
    reset_ic_reply_fr : reset_ic_reply_fr_size,\
    geometry_fr : geometry_fr_size,\
    str_conversion_fr : str_conversion_fr_size,\
    str_conversion_reply_fr : str_conversion_reply_fr_size,\
    preedit_start_fr : preedit_start_fr_size,\
    preedit_start_reply_fr : preedit_start_reply_fr_size,\
    preedit_draw_fr : preedit_draw_fr_size,\
    preedit_caret_fr : preedit_caret_fr_size,\
    preedit_caret_reply_fr : preedit_caret_reply_fr_size,\
    preedit_done_fr : preedit_done_fr_size,\
    status_start_fr : status_start_fr_size,\
    status_draw_text_fr : status_draw_text_fr_size,\
    status_draw_bitmap_fr : status_draw_bitmap_fr_size,\
    status_done_fr : status_done_fr_size,\
    ext_set_event_mask_fr : ext_set_event_mask_fr_size,\
    ext_forward_keyevent_fr : ext_forward_keyevent_fr_size,\
    ext_move_fr : ext_move_fr_size)

#define frame_free_func(FRAME) _Generic((FRAME), \
    ximattr_fr : ximattr_fr_free,\
    xicattr_fr : xicattr_fr_free,\
    ximattribute_fr : ximattribute_fr_free,\
    xicattribute_fr : xicattribute_fr_free,\
    ximtriggerkey_fr : ximtriggerkey_fr_free,\
    encodinginfo_fr : encodinginfo_fr_free,\
    str_fr : str_fr_free,\
    xpcs_fr : xpcs_fr_free,\
    ext_fr : ext_fr_free,\
    inputstyle_fr : inputstyle_fr_free,\
    attr_head_fr : attr_head_fr_free,\
    short_fr : short_fr_free,\
    long_fr : long_fr_free,\
    xrectangle_fr : xrectangle_fr_free,\
    xpoint_fr : xpoint_fr_free,\
    fontset_fr : fontset_fr_free,\
    input_styles_fr : input_styles_fr_free,\
    packet_header_fr : packet_header_fr_free,\
    error_fr : error_fr_free,\
    connect_fr : connect_fr_free,\
    connect_reply_fr : connect_reply_fr_free,\
    auth_required_fr : auth_required_fr_free,\
    auth_reply_fr : auth_reply_fr_free,\
    auth_next_fr : auth_next_fr_free,\
    auth_setup_fr : auth_setup_fr_free,\
    auth_ng_fr : auth_ng_fr_free,\
    disconnect_fr : disconnect_fr_free,\
    disconnect_reply_fr : disconnect_reply_fr_free,\
    open_fr : open_fr_free,\
    open_reply_fr : open_reply_fr_free,\
    close_fr : close_fr_free,\
    close_reply_fr : close_reply_fr_free,\
    register_triggerkeys_fr : register_triggerkeys_fr_free,\
    trigger_notify_fr : trigger_notify_fr_free,\
    trigger_notify_reply_fr : trigger_notify_reply_fr_free,\
    set_event_mask_fr : set_event_mask_fr_free,\
    encoding_negotiation_fr : encoding_negotiation_fr_free,\
    encoding_negotiation_reply_fr : encoding_negotiation_reply_fr_free,\
    query_extension_fr : query_extension_fr_free,\
    query_extension_reply_fr : query_extension_reply_fr_free,\
    get_im_values_fr : get_im_values_fr_free,\
    get_im_values_reply_fr : get_im_values_reply_fr_free,\
    create_ic_fr : create_ic_fr_free,\
    create_ic_reply_fr : create_ic_reply_fr_free,\
    destroy_ic_fr : destroy_ic_fr_free,\
    destroy_ic_reply_fr : destroy_ic_reply_fr_free,\
    set_ic_values_fr : set_ic_values_fr_free,\
    set_ic_values_reply_fr : set_ic_values_reply_fr_free,\
    get_ic_values_fr : get_ic_values_fr_free,\
    get_ic_values_reply_fr : get_ic_values_reply_fr_free,\
    set_ic_focus_fr : set_ic_focus_fr_free,\
    unset_ic_focus_fr : unset_ic_focus_fr_free,\
    forward_event_fr : forward_event_fr_free,\
    sync_fr : sync_fr_free,\
    sync_reply_fr : sync_reply_fr_free,\
    commit_fr : commit_fr_free,\
    commit_chars_fr : commit_chars_fr_free,\
    commit_both_fr : commit_both_fr_free,\
    reset_ic_fr : reset_ic_fr_free,\
    reset_ic_reply_fr : reset_ic_reply_fr_free,\
    geometry_fr : geometry_fr_free,\
    str_conversion_fr : str_conversion_fr_free,\
    str_conversion_reply_fr : str_conversion_reply_fr_free,\
    preedit_start_fr : preedit_start_fr_free,\
    preedit_start_reply_fr : preedit_start_reply_fr_free,\
    preedit_draw_fr : preedit_draw_fr_free,\
    preedit_caret_fr : preedit_caret_fr_free,\
    preedit_caret_reply_fr : preedit_caret_reply_fr_free,\
    preedit_done_fr : preedit_done_fr_free,\
    status_start_fr : status_start_fr_free,\
    status_draw_text_fr : status_draw_text_fr_free,\
    status_draw_bitmap_fr : status_draw_bitmap_fr_free,\
    status_done_fr : status_done_fr_free,\
    ext_set_event_mask_fr : ext_set_event_mask_fr_free,\
    ext_forward_keyevent_fr : ext_forward_keyevent_fr_free,\
    ext_move_fr : ext_move_fr_free)
